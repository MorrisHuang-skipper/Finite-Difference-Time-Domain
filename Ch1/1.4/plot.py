...
ax2.yaxis.set_major_locator(mpl.ticker.MultipleLocator(.6))
ax2.yaxis.set_minor_locator(mpl.ticker.MultipleLocator(.2))
...
for i in range(0, 601, 5):
    ...
    ax1.vlines(x=100, ymin=-1.5, ymax=1.5, color='grey')
    ax2.vlines(x=100, ymin=-1.8, ymax=1.8, color='grey')
    camera.snap()
