!========================================================
!   Purpose: 2D TM with plane wave impinging on a
!            dielectric cylinder and using Fourier 
!            Transformation for ananlysis
!
!   Methods: FDTD + PML + Fourier
!       
!       Date        Programer       Description of change
!       ====        =========       =====================
!      9/26/20       MorrisH        Original Code
!========================================================
PROGRAM main
    IMPLICIT NONE
    ...
    ! REAL(8) :: real_pt(NFREQS, IE, JE)
    ! REAL(8) :: imag_pt(NFREQS, IE, JE)
    ! REAL(8) :: amp(IE, JE), phase(IE, JE)
    REAL(8) :: real_in(5), imag_in(5)
    ! REAL(8) :: phase_in(5), amp_in(5)
    REAL(8) :: freq(3), arg(3)
    REAL(8) :: ga(IE, JE), gb(IE, JE)
    REAL(8) :: Dz(IE, JE), Ez(IE, JE)
    ...
    REAL(8) :: xdist, ydist, dist, radius
    INTEGER(8) :: l, n, i, j, ic, jc, T, npml, m
    ...
    eps = 30
    sigma = 0.3
    ! specify the dieletric cylinder
    do j = ja, jb-1
        do i = ia, ib-1
            !> sperical
            ! xdist = ic - i
